...
Page({
            ...
            success: (res) => {
                ...
                wx.request({
                    ...
                    success: (res) => {
                        ...
                        var arr = res.data.mx
                        var foods_list = wx.getStorageSync(that.data.order_message.shops_id).data
    ...
    toPayment(e) {
        ...
        this.setData({
            ...
            ['total.yczh']: this.data.scanCodeMsg,
            ['total.yhwmdzbz']: '',
    ...
    //     var scanCodeMsg = this.data.scanCodeMsg
    //     if (scanCodeMsg == undefined) {
    //         str = "请扫描桌号"
    //     }
    //     if (str.length == 0) {
    //         return true
